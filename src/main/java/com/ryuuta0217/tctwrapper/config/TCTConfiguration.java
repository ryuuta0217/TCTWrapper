...
public class TCTConfiguration {
    ...
    public static List<String> getConsoleCommandToWinner() {
        return Config.getConsoleCommandToWinner();
    }
    ...
    public static List<String> getConsoleCommandToLoser() {
        return Config.getConsoleCommandToLoser();
    }
    ...
    public static class RoleSetting {
        ...
        public static class Doctor {
            ...
            public static class Shop {
                ...
                public static boolean getStoneSwordEnabled() {
                    return !Config.getDisableItem_Doctor().contains(ItemType.STONE_SWORD);
                }
                ...
                public static boolean getBowEnabled() {
                    return !Config.getDisableItem_Doctor().contains(ItemType.BOW);
                }
                ...
                public static boolean getSpeedPotionEnabled() {
                    return !Config.getDisableItem_Doctor().contains(ItemType.SPEED_POTION);
                }
                ...
                public static boolean getAnalyzerEnabled() {
                    return !Config.getDisableItem_Doctor().contains(ItemType.ANALYZER_HOE);
                }
                ...
                public static boolean getCurseEnabled() {
                    return !Config.getDisableItem_Doctor().contains(ItemType.CURSE_BIN);
                }
                ...
                public static boolean getMilkEnabled() {
                    return !Config.getDisableItem_Doctor().contains(ItemType.MILK);
                }
                ...
                public static boolean getHealPotionEnabled() {
                    return !Config.getDisableItem_Doctor().contains(ItemType.HEAL_POTION);
                }
                ...
                public static boolean getCrackerEnabled() {
                    return !Config.getDisableItem_Doctor().contains(ItemType.CRACKER);
                }
        ...
        public static class Madman {
            ...
            public static class Shop {
                ...
                public static boolean getStoneSwordEnabled() {
                    return !Config.getDisableItem_Madman().contains(ItemType.STONE_SWORD);
                }
                ...
                public static boolean getBowEnabled() {
                    return !Config.getDisableItem_Madman().contains(ItemType.BOW);
                }
                ...
                public static boolean getSpeedPotionEnabled() {
                    return !Config.getDisableItem_Madman().contains(ItemType.SPEED_POTION);
                }
                ...
                public static boolean getAnalyzerEnabled() {
                    return !Config.getDisableItem_Madman().contains(ItemType.ANALYZER_HOE);
                }
                ...
                public static boolean getCurseEnabled() {
                    return !Config.getDisableItem_Madman().contains(ItemType.CURSE_BIN);
                }
                ...
                public static boolean getMilkEnabled() {
                    return !Config.getDisableItem_Madman().contains(ItemType.MILK);
                }
                ...
                public static boolean getHealPotionEnabled() {
                    return !Config.getDisableItem_Madman().contains(ItemType.HEAL_POTION);
                }
                ...
                public static boolean getCrackerEnabled() {
                    return !Config.getDisableItem_Madman().contains(ItemType.CRACKER);
                }
        ...
        public static class Fox {
            ...
            public static class Shop {
                ...
                public static boolean getStoneSwordEnabled() {
                    return !Config.getDisableItem_Fox().contains(ItemType.STONE_SWORD);
                }
                ...
                public static boolean getBowEnabled() {
                    return !Config.getDisableItem_Fox().contains(ItemType.BOW);
                }
                ...
                public static boolean getSpeedPotionEnabled() {
                    return !Config.getDisableItem_Fox().contains(ItemType.SPEED_POTION);
                }
                ...
                public static boolean getAnalyzerEnabled() {
                    return !Config.getDisableItem_Fox().contains(ItemType.ANALYZER_HOE);
                }
                ...
                public static boolean getCurseEnabled() {
                    return !Config.getDisableItem_Fox().contains(ItemType.CURSE_BIN);
                }
                ...
                public static boolean getMilkEnabled() {
                    return !Config.getDisableItem_Fox().contains(ItemType.MILK);
                }
                ...
                public static boolean getHealPotionEnabled() {
                    return !Config.getDisableItem_Fox().contains(ItemType.HEAL_POTION);
                }
                ...
                public static boolean getCrackerEnabled() {
                    return !Config.getDisableItem_Fox().contains(ItemType.CRACKER);
                }
    ...
    public static void save(boolean reload) {
        try {
            ...
            if(reload) Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "tctreload");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
